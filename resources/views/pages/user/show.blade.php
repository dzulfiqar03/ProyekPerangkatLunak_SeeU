                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6 col-lg-6 mb-4">
                            <img src="{{ Storage::url('files/documentUser/profileUMKM/' . $umkm->original_photoname) }}"
                                class="img-fluid rounded-3 shadow-lg w-100" alt="UMKM Image">
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="@if ($currentRouteName !== 'gstDetail' && $currentRouteName !== 'detailOwner' && $currentRouteName !== 'detailAll') {{ route('home', ['id' => $umkm->allumkm->id_user]) }}  @elseif($currentRouteName == 'detailAll') {{ route('allUmkm') }}  @elseif($currentRouteName === 'detailOwner') {{ route('owner', ['id' => $umkm->allumkm->id_user]) }}   @else {{ route('guest') }} @endif"
                ...
                <div class="row">
                    @foreach ($otherUmkm as $umkms)
                        <div class="col itemUMKM rounded-lg" id="searchResults">
                            <a href="@if ($currentRouteName === 'detailOwner') {{ route('detailOwner', ['id' => $umkms->id]) }} @elseif ($currentRouteName === 'detailAll') {{ route('detailAll', ['id' => $umkms->id]) }} @elseif ($currentRouteName === 'gstDetail') {{ route('gstDetail', ['id' => $umkms->id]) }} @else {{ route('detail', ['id' => $umkms->id]) }} @endif"
                                class="hover:bg-slate-200 cursor-pointer text-decoration-none text-black">
                                <div class="itemcard" style="width: 500px">
